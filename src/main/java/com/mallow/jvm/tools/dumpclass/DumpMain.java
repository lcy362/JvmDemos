...
public class DumpMain {
	...
	static String usage = "Usage:\n" + " java -jar dumpclass.jar <pid> <pattern> [outputDir] <--classLoaderPrefix>\n\n"
			...
			+ " java -cp \"./dumpclass.jar:$JAVA_HOME/lib/sa-jdi.jar\" com.mallow.jvm.tools.dumpclass.DumpMain <pid> <pattern> [outputDir] \n\n";
	...
	public static void main(String[] args)
		...
		System.setProperty("sun.jvm.hotspot.tools.jcore.filter", "com.mallow.jvm.tools.dumpclass.DumpWrapperFilter");
